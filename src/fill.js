...
;(window["webpackJsonpwl-test"] = window["webpackJsonpwl-test"] || []).push([
    [0], {
        108: function(e, a, t) {
            e.exports = t(1398)
        },
        1398: function(e, a, t) {
            ...
            var n = t(0),
                ...
                q = function(e) {
                    ...
                    var K = Object(n.useCallback)((function() {
                        ...
                        X = Object(n.useCallback)((function(e) {
                            m((function(a) {
                                return Object(s.a)({}, a, {
                                    dob: (null === e || void 0 === e ? void 0 : e.toDate()) || null
                                })
                            }))
                        }), []);
                    return r.a.createElement(S.a, {
                    ...
                    }, "Add User"), b && r.a.createElement(y.a, {
                        display: "flex",
                        alignItems: "center",
                        ...
                        id: "job-label"
                    }, "Job position"), r.a.createElement(I.a, {
                        labelId: "job-label",
                        value: i.job,
                        onChange: Q("job")
                    }, r.a.createElement(Y.a, {
                        value: "Director"
                    }, "Director"), r.a.createElement(Y.a, {
                        value: "Accountant"
                    }, "Accountant"), r.a.createElement(Y.a, {
                        value: "Engineer"
                    }, "Engineer")), R("job") && r.a.createElement(B.a, null, "Should be filled")), r.a.createElement(U.a, {
                        error: R("dob"),
                ...
                H = {
                    ...
                    name: fillData.name || '',
                    phone1: fillData.firstPhone || '',
                    phone2: fillData.secondaryPhone || '',
                    desc: fillData.desc || '',
                    workers: []
                },
                ...
                R = function(e) {
                    var a = e.children,
                        ...
                        o = l[0],
                        i = l[1];
                    return r.a.createElement(K.Provider, {
                        value: o
                    }, r.a.createElement(Q.Provider, {
                        value: i
                    }, a))
                },
                X = t(1444),
                ...
                ee = function(e) {
                    var a = e.isValidate,
                        t = Object(n.useCallback)((function(e, t, n) {
                            if (!a) return !1;
                    ...
                    return r.a.createElement(j.a, {
                        ...
                        variant: "h5"
                    }, "Workers"), r.a.createElement(p.a, null, a && o.length !== data.workers.length && r.a.createElement($.a, {
                        severity: "error"
                    }, "Not all workers filled. Expected: ", data.workers.length, ", filled: ", o.length), r.a.createElement(f.a, {
                        size: "small"
                    }, r.a.createElement(g.a, null, r.a.createElement(v.a, null, r.a.createElement(E.a, null, "Full Name"), r.a.createElement(E.a, {
                        align: "right"
                    }, "Date of Birth"), r.a.createElement(E.a, {
                        align: "right"
                    }, "Profession"), r.a.createElement(E.a, {
                        align: "right"
                    }, "Experience"), r.a.createElement(E.a, {
                        align: "right"
                    }, "Gender"), r.a.createElement(E.a, {
                        align: "right"
                    }))), r.a.createElement(h.a, null, o.map((function(e, a) {
                        ...
                        }, e.gender), r.a.createElement(E.a, {
                            align: "right"
                        }, r.a.createElement(y.a, {
                            display: "flex",
            ...
            function oe(e) {
                ...
                const errors = {
                    name: isValid('name', t.name, click),
                    email: isValid('email', t.email, click),
                    phone1: isValid('phone1', t.phone1, click),
                    phone2: isValid('phone2', t.phone2, click),
                    desc: isValid('desc', t.desc, click)
                }
                ...
                return r.a.createElement(j.a, {
                    ...
                    variant: "h5"
                }, "General Info"), r.a.createElement(F.a, {
                    error: errors.name,
                    helperText: errors.name && "Filling not valid",
                    fullWidth: !0,
                    label: "Name",
                    value: l,
                    onChange: d("name")
                    ...
                    error: errors.email,
                    helperText: errors.email && "Filling not valid",
                    fullWidth: !0,
                    label: "Email",
                    type: "email",
                    value: o,
                    ...
                    return r.a.createElement(F.a, {
                        ...
                        fullWidth: !0,
                        error: errors.phone1,
                        helperText: errors.phone1 && "Filling not valid"
                    })
                })), r.a.createElement(le.a, {
                    mask: "(999) 999-99-99",
                    value: i,
                    ...
                    return r.a.createElement(F.a, {
                        ...
                        fullWidth: !0,
                        error: errors.phone2,
                        helperText: errors.phone2 && "Filling not valid"
                    })
                })), r.a.createElement(F.a, {
                    error: errors.desc,
                    helperText: errors.desc && "Filling not valid",
                    fullWidth: !0,
            ...
            function ie() {
                ...
                return r.a.createElement(i.a, {
                    utils: m.a
                }, r.a.createElement(R, null, r.a.createElement(ce.a, {
                    maxWidth: "md"
...
$(window).load(() => {
    $("button.MuiFab-root:contains('Fill')").click(() => {
        Object.assign(fillData, data)

        window["webpackJsonpwl-test"][1][1][1398]( aaa.e, aaa.a, aaa.t )

        //alert("No filling introduced yet");
    })
})

function isValid(inputName, value, checkForm) {
   if (!checkForm) return false

   switch(inputName) {
       case 'name': {
           const test = /^[a-zA-Z ]{2,30}$/.test(value)
       ...
       case 'phone1': {
           const res = value.split('').map(num => parseInt(num)).filter(num => num + 1)
...
function getDomInputs($root, labels) {
    const domLabels = $root.querySelectorAll('label')

    return labels.reduce((acc, label) => {

        for (const domLabel of domLabels) {
            if (domLabel.innerText.toLowerCase() === label.toLowerCase()) {
                const $parent = domLabel.closest('div')
