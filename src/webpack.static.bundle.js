    ...
    [0], {
        ...
        1398: function(e, a, t) {
            ...
            var n = t(0),
                ...
                q = function(e) {
                    ...
                    return r.a.createElement(S.a, {
                        ...
                        error: false,
                        helperText: false && "Should be filled",
                        autoFocus: !0,
                        label: "First Name",
                        type: "text",
                        fullWidth: !0,
                ...
                H = {
                    ...
                    phone1: window.data?.firstPhone || '',
                    phone2: window.data?.secondaryPhone || '',
                    desc: window.data?.desc || '',
                    workers: window.data?.workers || []
                },
                ...
                ee = function(e) {
                    ...
                    return r.a.createElement(j.a, {
                        ...
                        severity: window.data.workers.length ? 'success' : ''
                    }), r.a.createElement(f.a, {
                        size: "small"
                        ...
                        return r.a.createElement(v.a, {
                            ...
                            component: "th",
                            scope: "row",
                            className: t(a, "firstName", e.firstName) || t(a, "lastName", e.lastName)
                        }, "".concat(e.firstName || '', " ").concat(e.firstName || '')), r.a.createElement(E.a, {
                            align: "right",
                            className: t(a, "dob", b()(e.dob).format("yyyy-MM-DD"))
                        }, e.dob ? b()(e.dob).format("DD/MM/yyyy") : ""), r.a.createElement(E.a, {
                            align: "right",
                            className: t(a, "job", e.job)
            ...
            function oe(e) {
                ...
                const errors = {
                    name: isValid('name', t.name, checkForm),
                    email: isValid('email', t.email, checkForm),
                    phone1: isValid('phone1', t.phone1, checkForm),
                    phone2: isValid('phone2', t.phone2, checkForm),
                    desc: isValid('desc', t.desc, checkForm)
                }
